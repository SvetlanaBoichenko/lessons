 ...
 class AInterface extends AObject {
  ...
  public String read_data (int port_num) {
     ...
     if(port_num >= 0)
      ...
      return "Объект Interface1 вызывает функц read_data";
   }
        
   public String GetReadBuf () {
      return "ф. ReadBuf для Interface1 ";  
    }
}
//-------------------------------------------
...
class ASensor extends AObject  {
  ...
  public String Operate () { 
      ...
      return "ф. Operate для для Sensor1 ";
   }   
}
//----------------------------
